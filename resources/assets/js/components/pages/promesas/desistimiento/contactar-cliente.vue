						...
						<div class="row total align-items-end">
							<div class="col-12">
								<div class="input-cont checklists">
									<label class="label">Desistimiento</label>
									<div class="radio">
										<input id="si1" type="radio" name="enviado" value="desiste" v-model="fields.cliente_desiste.value" :disabled="terminado || !permiso" @change="disableTermino">
										<label for="si1">Cliente desiste</label>
									</div>
									<div class="radio">
										<input id="no1" type="radio" name="enviado" value="no desiste" v-model="fields.cliente_desiste.value" :disabled="terminado || !permiso" @change="disableTermino">
										<label for="no1">Cliente no desiste</label>
									</div>
								</div>
							</div>
	...
	export default{
		...
		methods: {
			...
			terminarActividad: function(){
				...
				this.action = true;
				this.$nodos.terminarActividad({nodo: this.data.nodo, marca: this.data.promesa.marca, cliente_desiste: this.fields.cliente_desiste.value}, () => {
