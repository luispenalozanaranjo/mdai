						...
						<div class="row total align-items-center">
							<div class="col-4">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input" v-model="fields.devolucion_cliente.value" :disabled="terminado || !permiso" @change="disableTermino">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description">Devolucion a cliente</span>
									</label>
								</div>
							</div>
							<div class="col-4">
								<div class="input-cont">
									<label class="label">Fecha recepción documento</label>
									<div class="cont">
										<input type="date" v-model="fields.devolucion_cliente_fecha.value" :disabled="terminado || !permiso" @change="disableTermino">
									</div>
								</div>
							</div>
							<div class="col-12">
