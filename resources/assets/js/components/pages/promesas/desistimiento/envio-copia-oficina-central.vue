						...
						<div class="row total align-items-center">
							<div class="col-4">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input" v-model="fields.copia_resciliacion.value" :disabled="terminado || !permiso" @change="disableTermino">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description">2 Copias resciliación</span>
									</label>
								</div>
							</div>
							<div class="col-4">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input" v-model="fields.notificacion_renuncia.value" :disabled="terminado || !permiso" @change="disableTermino">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description">1 Notificación de renuncia</span>
									</label>
								</div>
							</div>
							<div class="col-4">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input" v-model="fields.constatacion_fisica.value" :disabled="terminado || !permiso" @change="disableTermino">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description">Constatación fisica</span>
									</label>
								</div>
							</div>
							<div class="col-6">
							...
							<div class="col-6" v-if="fields.tipo_envio.value === 'Enviado'">
								<div class="input-cont">
									...
									<div class="cont">
										<input type="text" name="comprobante" v-model="fields.chilexpress.value" :readonly="terminado ">
									</div>
								</div>
							</div>
							<div class="col-12">
					...
					<template slot="action">
						<div class="btn-holder">
							<div class="row total mini align-items-center">
								<div class="col-6">
									<a :href="route('desistimiento', data.promesa.opp)" class="text-link">
		...
		methods: {
			...
			terminarActividad: function(){
				...
				this.$nodos.terminarActividad({nodo: this.data.nodo, marca: this.data.promesa.marca}, () => {
					...
					window.location.replace( this.route('desistimiento', this.data.promesa.opp) );
				})
				.finally(() => {
					setTimeout(() => {
						this.action = false;
