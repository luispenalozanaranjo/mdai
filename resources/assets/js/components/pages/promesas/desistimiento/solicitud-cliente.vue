						...
						<div class="row total align-items-center">
							<div class="col-4">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input" v-model="fields.constatacion_renuncia.value" :disabled="terminado || !permiso" @change="disableTermino">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description" v-text="fields.constatacion_renuncia.nombre"></span>
									</label>
								</div>
							</div>
							<div class="col-8">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input" v-model="fields.fotocopia_carnet.value" :disabled="terminado || !permiso" @change="disableTermino">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description"  v-text="fields.fotocopia_carnet.nombre"></span>
									</label>
								</div>
							</div>
							<div class="col-12">
