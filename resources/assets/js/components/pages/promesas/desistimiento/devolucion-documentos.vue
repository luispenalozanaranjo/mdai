						...
						<div class="row total align-items-center">
							<div class="col-12">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input" v-model="fields.stock_manual.value" :disabled="terminado || !permiso" @change="disableTermino">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description">Devolución documentos</span>
									</label>
								</div>
							</div>
							<div class="col-12">
