					...
					<div class="row total align-items-end">
						<div class="col-3">
							<div class="input-cont checklists">
								...
								<div class="radio">
									<input id="si1" type="radio" name="enviado" value="autoriza" v-model="fields.autoriza.value" :disabled="terminado || !permiso" @change="disableTermino">
									<label for="si1">Sí</label>
								</div>
								<div class="radio">
									<input id="no1" type="radio" name="enviado" value="no autoriza" v-model="fields.autoriza.value" :disabled="terminado || !permiso" @change="disableTermino">
	...
	export default{
		...
		methods: {
			...
			terminarActividad: function(){
				...
				this.action = true;
				this.$nodos.terminarExcepcion({ excepcion: this.data.detalle, nodo: this.data.nodo, autoriza: this.fields.autoriza.value }, () => {
