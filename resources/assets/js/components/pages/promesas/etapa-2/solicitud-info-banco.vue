        ...
        <template slot="content">
          ...
          <div class="row total align-items-center">
              ...
              <div class="input-cont checkbox">
                <label>
                  <input
                    ...
                    v-model="fields.solicitud_informacion.value"
                    :disabled="terminado || !permiso"
                    @change="disableTermino"
                  />
                  <span class="fill-control-indicator"></span>
                  <span
                    class="fill-control-description"
                    v-text="fields.solicitud_informacion.nombre"
                  ></span>
                </label>
              </div>
            </div>
            <div class="col-12 col-sm">
              <div class="input-cont checkbox" v-if="fields.solicitud_informacion.value">
                <label>
                  <input
                    type="checkbox"
                    class="fill-control-input"
                    v-model="fields.aprobacion_bancaria.value"
                    :disabled="terminado || !permiso"
                  />
                  <span class="fill-control-indicator"></span>
                  <span class="fill-control-description" v-text="fields.aprobacion_bancaria.nombre"></span>
                </label>
              </div>
            </div>
            <div class="col-12 col-sm">
              <div
                class="input-cont checkbox"
                v-if="fields.solicitud_informacion.value && fields.aprobacion_bancaria.value"
              >
                <label>
                  <input
                    type="checkbox"
                    class="fill-control-input"
                    v-model="fields.en_formalizacion_credito.value"
                    :disabled="terminado || !permiso"
                  />
                  <span class="fill-control-indicator"></span>
                  <span
                    class="fill-control-description"
                    v-text="fields.en_formalizacion_credito.nombre"
                  ></span>
                </label>
              </div>
            </div>
            <div class="col-12 col-sm">
              <div
                class="input-cont checkbox"
                v-if="fields.solicitud_informacion.value && fields.aprobacion_bancaria.value && fields.en_formalizacion_credito.value"
              >
                <label>
                  <input
                    type="checkbox"
                    class="fill-control-input"
                    v-model="fields.set_credito_firmado.value"
                    :disabled="terminado || !permiso"
                  />
                  <span class="fill-control-indicator"></span>
            ...
            <div class="col-12 col-sm">
              <div
                class="input-cont checkbox"
                v-if="fields.solicitud_informacion.value && fields.aprobacion_bancaria.value && fields.en_formalizacion_credito.value && fields.set_credito_firmado.value"
              >
                <label>
                  <input
                    type="checkbox"
                    class="fill-control-input"
                    v-model="fields.cliente_listo_escriturar.value"
                    :disabled="terminado || !permiso"
                  />
                  <span class="fill-control-indicator"></span>
                  <span
                    class="fill-control-description"
                    v-text="fields.cliente_listo_escriturar.nombre"
                  ></span>
                </label>
              </div>
            </div>
            <div class="col-12 col-sm">
              <div
                class="input-cont checkbox"
                v-if="fields.solicitud_informacion.value && fields.aprobacion_bancaria.value && fields.en_formalizacion_credito.value && fields.set_credito_firmado.value && fields.cliente_listo_escriturar.value"
              >
                <label>
                  <input
                    type="checkbox"
                    class="fill-control-input"
                    v-model="fields.pre_ode.value"
                    :disabled="terminado || !permiso"
                  />
                  <span class="fill-control-indicator"></span>
...
export default {
  ...
  data: function () {
    return {
      ...
      terminar: false,
      modalTerminar: false,
      dataFields: [1, 50, 51, 178, 179, 180, 181],
      fields: null,
      errors: [],
      action: false,
      submitAction: false,
  ...
  methods: {
    ...
    disableTermino: function () {
      this.terminar = false;
      this.fields.aprobacion_bancaria.value = null;
    },
