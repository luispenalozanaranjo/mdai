					...
					<div class="row total align-items-center">
						<div class="col-3">
							<div class="input-cont checkbox">
								<label>
									<input type="checkbox" class="fill-control-input" v-model="fields.enviado_notaria.value" :disabled="terminado || !permiso" @change="disableTermino">
									<span class="fill-control-indicator"></span>
									<span class="fill-control-description" v-text="fields.enviado_notaria.nombre"></span>
								</label>
							</div>
						</div>
						<div class="col-3">
							<div class="input-cont checkbox" v-if="fields.enviado_notaria.value">
								<label>
									<input type="checkbox" class="fill-control-input" v-model="fields.recepcionado_notaria.value" :disabled="terminado || !permiso">
									<span class="fill-control-indicator"></span>
									<span class="fill-control-description" v-text="fields.recepcionado_notaria.nombre"></span>
								</label>
							</div>
						</div>
						<div class="col-12">
	...
	export default{
		...
		methods: {
			...
			checkTermino: function(){
				...
				if( !this.$methods.checkNullEmpty(this.fields.enviado_notaria.value) && 
					!this.$methods.checkNullEmpty(this.fields.recepcionado_notaria.value) &&
			...
			disableTermino: function(){
				this.terminar = false;
				this.fields.recepcionado_notaria.value = null;
			},
