						...
						<div class="row total  align-items-end">
							<div class="col-6">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input" v-model="fields.envio_correo_cliente.value" :disabled="terminado || !permiso">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description" v-text="fields.envio_correo_cliente.nombre"></span>
									</label>
								</div>
							</div>
							<div class="col-12">
