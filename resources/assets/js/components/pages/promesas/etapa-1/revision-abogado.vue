					...
					<div class="row total align-items-center">
						<div class="col-3">
							<div class="input-cont checkbox">
								<label>
									<input type="checkbox" class="fill-control-input" v-model="fields.carpeta_entregada.value" :disabled="terminado || !permiso" @change="disableTermino">
									<span class="fill-control-indicator"></span>
									<span class="fill-control-description" v-text="fields.carpeta_entregada.nombre"></span>
								</label>
							</div>
						</div>
						<div class="col-3">
							<div class="input-cont checkbox" v-if="fields.carpeta_entregada.value">
								<label>
									<input type="checkbox" class="fill-control-input" v-model="fields.carpeta_revisada.value" :disabled="terminado || !permiso">
									<span class="fill-control-indicator"></span>
									<span class="fill-control-description" v-text="fields.carpeta_revisada.nombre"></span>
								</label>
							</div>
						</div>
						<div class="col-12">
	...
	export default{
		...
		methods: {
			...
			checkTermino: function(){
				...
				if( !this.$methods.checkNullEmpty(this.fields.carpeta_entregada.value) && 
					!this.$methods.checkNullEmpty(this.fields.carpeta_revisada.value) &&
			...
			disableTermino: function(){
				this.terminar = false;
				this.fields.carpeta_revisada.value = null;
			},
