					...
					<div class="row total align-items-center">
						<div class="col-3">
							<div class="input-cont checkbox">
								<label>
									<input type="checkbox" class="fill-control-input" v-model="fields.recepcionado.value" :disabled="terminado || !permiso" @change.prevent="checkTermino">
									<span class="fill-control-indicator"></span>
									<span class="fill-control-description">Recepcionado Oficina Venta</span>
								</label>
							</div>
						</div>
						<div class="col-3">
							<div class="input-cont checkbox" v-if="fields.recepcionado.value">
								<label>
									<input type="checkbox" class="fill-control-input" v-model="fields.promesa_entregada.value" :disabled="terminado || !permiso" @change.prevent="disableTermino">
									<span class="fill-control-indicator"></span>
									<span class="fill-control-description">Promesa entregada</span>
								</label>
							</div>
						</div>
						<div class="col-12">
	...
	export default{
		...
		methods: {
			...
			checkTermino: function(){
				...
				if( this.fields.recepcionado.value && this.fields.promesa_entregada.value &&
