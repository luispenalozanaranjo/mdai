						...
						<div class="row total align-items-end">
							<div class="col-3">
								<div class="input-cont checklists">
									<label class="label">Visado carpeta</label>
									<div class="radio">
										<input id="si1" type="radio" name="enviado" value="1" v-model="fields.visado_carpeta.value" :disabled="terminado || !permiso" @change="disableTermino">
										<label for="si1">Sí</label>
									</div>
									<div class="radio">
										<input id="no1" type="radio" name="enviado" value="0" v-model="fields.visado_carpeta.value" :disabled="terminado || !permiso" @change="disableTermino">
							...
							<div class="col-3">
								<div class="input-cont checklists">
									<label class="label">Stock manual</label>
									<div class="radio">
										<input id="si2" type="radio" name="retirado" value="1" v-model="fields.stock_manual.value" :disabled="terminado || !permiso" @change="disableTermino">
										<label for="si2">Sí</label>
									</div>
									<div class="radio">
										<input id="no2" type="radio" name="retirado" value="0" v-model="fields.stock_manual.value" :disabled="terminado || !permiso" @change="disableTermino">
	...
	export default{
		...
		methods: {
			...
			checkTermino: function(){
				...
				if( !this.$methods.checkNullEmpty(this.fields.visado_carpeta.value) && this.fields.visado_carpeta.value === "1" &&
					!this.$methods.checkNullEmpty(this.fields.stock_manual.value) && this.fields.stock_manual.value === "1" && 
