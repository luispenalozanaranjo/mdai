				...
				<mdai-box :title="data.nodo.nodo.subactividad">
					<template slot="content">
						...
						<div class="row total mini">
							<div class="col-4">
								<mdai-select :disabled="terminado || !permiso" v-model="fields.asignado.value" :data="data.ejecutivos" label="Asignar a" val="id">
	...
	export default{
		...
		methods: {
			...
			checkTermino: function(){
				...
				if( !this.$methods.checkNullEmpty(this.fields.asignado.value) && 
			...
			terminarActividad: function(){
				...
				this.action = true;
				this.data.nodo.usuario = this.fields.asignado.value;
