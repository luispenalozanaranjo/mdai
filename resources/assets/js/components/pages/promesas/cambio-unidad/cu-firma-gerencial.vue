		...
		<form class="content-block" @submit.prevent="validateForm" v-if="fields">
			<mdai-box :title="data.nodo.subactividad">
                ...
                <div class="row">
                    	...
                    	<div class="col-3">
                            <label>Autoriza firma representante 1</label>
								<div class="input-cont checkbox">
									<label>
                                        
										<input type="checkbox" class="fill-control-input">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description">aprobado</span>
									</label>
								</div>
							</div>
                            <div class="col-3">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description">No aprueba</span>
									</label>
								</div>
							</div>

                            <div class="col-3">
                            <label>Autoriza firma representante 2</label>
								<div class="input-cont checkbox">
									<label>
