						...
						<div class="row total align-items-center">
							<div class="col-4">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input" v-model="fields.contactar_cliente.value" :disabled="terminado || !permiso" @change="disableTermino">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description">Contacto a cliente</span>
									</label>
								</div>
							</div>
							<div class="col-4">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input" v-model="fields.cliente_firma.value" :disabled="terminado || !permiso" @change="disableTermino">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description" v-text="fields.cliente_firma.nombre"></span>
									</label>
								</div>
							</div>
							<div class="col-4">
								<div class="input-cont checkbox">
									<label>
										<input type="checkbox" class="fill-control-input"  v-model="fields.envio_comprobante_email.value" :disabled="terminado || !permiso" @change="disableTermino">
										<span class="fill-control-indicator"></span>
										<span class="fill-control-description" v-text="fields.envio_comprobante_email.nombre"></span>
									</label>
								</div>
							</div>
							<div class="col-12">
		...
		methods: {
			...
			validateForm: function(){
				...
				if( !this.submitAction ){
					...
					if(this.$methods.checkNullEmpty(this.fields.contactar_cliente.value) ||
					  this.$methods.checkNullEmpty(this.fields.cliente_firma.value)||
					  this.$methods.checkNullEmpty(this.fields.envio_comprobante_email.value)){
			...
			checkTermino: function(){
				...
				if( !this.$methods.checkNullEmpty(this.fields.contactar_cliente.value) && 
					this.fields.contactar_cliente.value ==1 && !this.$methods.checkNullEmpty(this.fields.cliente_firma.value) &&
					this.fields.cliente_firma.value == 1 && !this.$methods.checkNullEmpty(this.fields.observaciones.value)
					&& this.fields.envio_comprobante_email.value == 1 && !this.$methods.checkNullEmpty(this.fields.envio_comprobante_email.value)){
					this.terminar = true;
				}else{
					this.terminar = false;
				}
