                    ...
                    <div class="input-cont checkbox">
                      <label>
                        <input
                          ...
                          v-model="fields.egreso_cbr_ok.value"
                          :disabled="terminado || !permiso"
                        />
                        <span class="fill-control-indicator"></span>
                        <span class="fill-control-description">Egreso CBR OK</span>
                      </label>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="input-cont">
                      <div class="cont">
                        <input
                          ...
                          v-model="fields.egreso_cbr_ok.observaciones"
                    ...
                    <div class="input-cont checkbox">
                      <label>
                        <input
                          type="checkbox"
                          class="fill-control-input"
                          v-model="fields.copias_compraventa.value"
                          :disabled="terminado || !permiso"
                        />
                        <span class="fill-control-indicator"></span>
                        <span class="fill-control-description">Copias compraventa OK</span>
                      </label>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="input-cont">
                      <div class="cont">
                        <input
                          type="text"
                          placeholder="Observaciones"
                          v-model="fields.copias_compraventa.observaciones"
                          :readonly="terminado || !permiso"
                        />
                      </div>
                    </div>
                    ...
                    <div class="input-cont checkbox">
                      <label>
                        <input
                          type="checkbox"
                          class="fill-control-input"
                          v-model="fields.carpeta_serviu_completa.value"
                          :disabled="terminado || !permiso"
                        />
                        <span class="fill-control-indicator"></span>
                        <span class="fill-control-description">Carpeta serviu completa</span>
                      </label>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="input-cont">
                      <div class="cont">
                        <input
                          type="text"
                          placeholder="Observaciones"
                          v-model="fields.carpeta_serviu_completa.observaciones"
                          :readonly="terminado || !permiso"
                        />
                      </div>
                    </div>
                    ...
                    <div class="input-cont checkbox">
                      <label>
                        <input
                          type="checkbox"
                          class="fill-control-input"
                          v-model="fields.ingreso_serviu_ok.value"
                          :disabled="terminado || !permiso"
                        />
                        <span class="fill-control-indicator"></span>
                        <span class="fill-control-description">Ingreso a serviu OK</span>
                      </label>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="input-cont">
                      <div class="cont">
                        <input
                          type="text"
                          placeholder="Observaciones"
                          v-model="fields.ingreso_serviu_ok.observaciones"
                          :readonly="terminado || !permiso"
                        />
                      </div>
                    </div>
                    ...
                    <div class="input-cont checkbox">
                      <label>
                        <input
                          type="checkbox"
                          class="fill-control-input"
                          v-model="fields.pago_serviu_ok.value"
                          :disabled="terminado || !permiso"
                        />
                        <span class="fill-control-indicator"></span>
                        <span class="fill-control-description">Pago serviu OK</span>
                      </label>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="input-cont">
                      <div class="cont">
                        <input
                          type="text"
                          placeholder="Observaciones"
                          v-model="fields.pago_serviu_ok.observaciones"
                          :readonly="terminado || !permiso"
                        />
                      </div>
                    </div>
                    ...
                    <div class="input-cont checkbox">
                      <label>
                        <input
                          type="checkbox"
                          class="fill-control-input"
                          v-model="fields.carpeta_ahorro_completa.value"
                          :disabled="terminado || !permiso"
                        />
                        <span class="fill-control-indicator"></span>
                        <span class="fill-control-description">Carpeta ahorro completa</span>
                      </label>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="input-cont">
                      <div class="cont">
                        <input
                          type="text"
                          placeholder="Observaciones"
                          v-model="fields.carpeta_ahorro_completa.observaciones"
                          :readonly="terminado || !permiso"
                        />
                      </div>
                    </div>
                    ...
                    <div class="input-cont checkbox">
                      <label>
                        <input
                          type="checkbox"
                          class="fill-control-input"
                          v-model="fields.ingreso_ahorro_ok.value"
                          :disabled="terminado || !permiso"
                        />
                        <span class="fill-control-indicator"></span>
                        <span class="fill-control-description">Ingreso a ahorro OK</span>
                      </label>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="input-cont">
                      <div class="cont">
                        <input
                          type="text"
                          placeholder="Observaciones"
                          v-model="fields.ingreso_ahorro_ok.observaciones"
                          :readonly="terminado || !permiso"
                        />
                      </div>
                    </div>
                    ...
                    <div class="input-cont checkbox">
                      <label>
                        <input
                          type="checkbox"
                          class="fill-control-input"
                          v-model="fields.pago_ahorro_ok.value"
                          :disabled="terminado || !permiso"
                        />
                        <span class="fill-control-indicator"></span>
                        <span class="fill-control-description">Pago ahorro OK</span>
                      </label>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="input-cont">
                      <div class="cont">
                        <input
                          type="text"
                          placeholder="Observaciones"
                          v-model="fields.pago_ahorro_ok.observaciones"
                          :readonly="terminado || !permiso"
                        />
                      </div>
                    </div>
                    ...
                    <div class="input-cont checkbox">
                      <label>
                        <input
                          type="checkbox"
                          class="fill-control-input"
                          v-model="fields.pago_chip_ok.value"
                          :disabled="terminado || !permiso"
                        />
                        <span class="fill-control-indicator"></span>
                        <span class="fill-control-description">Pago CHIP OK</span>
                      </label>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="input-cont">
                      <div class="cont">
                        <input
                          type="text"
                          placeholder="Observaciones"
                          v-model="fields.pago_chip_ok.observaciones"
                          :readonly="terminado || !permiso"
                        />
                      </div>
                    </div>
                    ...
                    <div class="input-cont checkbox">
                      <label>
                        <input
                          type="checkbox"
                          class="fill-control-input"
                          v-model="fields.pago_vale_notaria_ok.value"
                          :disabled="terminado || !permiso"
                        />
                        <span class="fill-control-indicator"></span>
                        <span class="fill-control-description">Pagos vale vista notaria OK</span>
                      </label>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="input-cont">
                      <div class="cont">
                        <input
                          type="text"
                          placeholder="Observaciones"
                          v-model="fields.pago_vale_notaria_ok.observaciones"
                          :readonly="terminado || !permiso"
                        />
                      </div>
                    </div>
              ...
              <div class="row total mini align-items-center">
                ...
                <div class="col-6">
                  <div class="text-right">
                    ...
                    <button
                      type="button"
                      v-if="terminar && !terminado"
                      @click.prevent="modalTerminar = true"
                    ...
                    <p class="f-12" v-if="terminado">
                      <span
                        class="fw-bold"
                      >{{ data.nodo.terminado.nombres }} {{ data.nodo.terminado.apellidos }}</span> terminó esta actividad el
                      <span class="fw-bold">{{ data.nodo.salida_format }}</span>.
                    </p>
                  </div>
                </div>
              </div>
...
export default {
  ...
  data: function () {
    return {
      ...
      terminar: false,
      modalTerminar: false,
      dataFields: [1, 193, 194, 199, 200, 201, 202, 203, 204, 205, 206],
      fields: null,
      errors: [],
      action: false,
      submitAction: false,
